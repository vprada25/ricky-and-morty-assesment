...
export const CharacterDetailPanel: FC = () => {
  ...
  if (!currentCharacter) {
    return (
      <div className='items-center justify-center mx-auto h-screen flex'>
        <p className='text-text-secondary hidden lg:block'>
    ...
    <div className='max-w-full mx-auto'>
      ...
      <div>
        <div className='py-3 border-b border-gray-200'>
          <h3 className='text-sm font-semibold text-text-primary mb-1.5'>Specie</h3>
          <p className='text-sm text-gray-600'>{currentCharacter.species}</p>
        </div>

        <div className='py-3 border-b border-gray-200'>
          <h3 className='text-sm font-semibold text-text-primary mb-1.5'>Status</h3>
